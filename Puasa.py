...
def ascii_art():
    ...
    print(colored(r" ______     __  __       ________       ______       ________      ", 'yellow', attrs=['bold']))
    print(colored(r"/_____/\   /_/\/_/\     /_______/\     /_____/\     /_______/\     ", 'yellow', attrs=['bold']))
    print(colored(r"\:::_ \ \  \:\ \:\ \    \::: _  \ \    \::::_\/_    \::: _  \ \    ", 'yellow', attrs=['bold']))
    print(colored(r" \:(_) \ \  \:\ \:\ \    \::(_)  \ \    \:\/___/\    \::(_)  \ \   ", 'yellow', attrs=['bold']))
...
def membaca_teks_dan_kuis():
    ...
    pertanyaan = [
        {"tanya": "1. Apa arti puasa dalam konteks Ramadhan?", "jawab": "menahan diri"},
        {"tanya": "2. Kapan waktu pelaksanaan puasa dimulai dan berakhir setiap harinya?", "jawab": "terbit fajar hingga terbenam matahari"},
        {"tanya": "3. Sebutkan salah satu manfaat puasa selain menahan lapar dan dahaga!", "jawab": "melatih kesabaran"},
        {"tanya": "4. Ibadah apa yang dianjurkan untuk diperbanyak selama Ramadhan?", "jawab": "shalat"},
        {"tanya": "5. Apa tujuan utama dari berpuasa Ramadhan?", "jawab": "meningkatkan ketakwaan"}
    ]
...
def sejarah_puasa_ramadhan():
    teks_sejarah = (
        ...
        "jiwa agar menjadi lebih sabar dan bertakwa kepada Allah SWT.\n"
    )
...
def tampilkan_nama_kelompok_lagi():
    ...
    anggota = ["Rahmat Hidayat", "Raissa Putri", "Rakan Rizq", "Rara Tamiya", "Rajwa Nuha", "Rani Nurhamidah"]
